...
$core .= file_get_contents(BASE . 'js/core/terrific-2.1.0.min.js') . "\n";
$core .= file_get_contents(BASE . 'js/core/doT-1.0.1.min.js') . "\n";
$core .= file_get_contents(BASE . 'js/core/core.js') . "\n";
